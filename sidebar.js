...
const allProjects = {
    ...
    '19_modoo-card-calculator': {
        ...
        desc: '2026 모두의 카드 환급을 정률·정액상한 중 유리한 방식으로 자동 계산 (K패스 확대체계·GTX 포함)',
        categories: ['생활정보', '교통', '계산기'],
        keywords: ['모두의카드', '모두의카드계산기', '모두의카드환급', '모두의카드환급액계산', '모두의카드신청', '모두의카드K패스차이', '모두의카드기준금액', '모두의카드일반형플러스형', '반값모두의카드', '모두의카드청년', '모두의카드저소득', '모두의카드GTX', '기후동행패스', '대중교통비환급']
    },
    ...
    'kpass-refund-calculator': {
        name: 'K패스 환급 계산기 (지자체별)',
        url: 'https://kpass.winevisionshop.kr/',
        desc: '2026 K패스 대중교통비 환급을 지역·대상별로 계산 (The경기패스·인천 I패스·세종 이응패스 등 지자체 비교)',
        categories: ['생활정보', '교통', '계산기'],
        keywords: ['K패스', 'K패스환급', 'K패스계산기', 'K패스환급률', 'K패스신청', 'K패스청년', 'K패스저소득', 'The경기패스', '경기패스61회', '인천I패스', '인천차비드림', '광주G패스', '울산U패스', '경남패스', '부산동백패스', '세종이응패스', 'K패스모두의카드차이', '대중교통비환급']
    },
    'property-holding-tax': {
        name: '부동산 세금 계산기 (재산세·종부세·양도세)',
        url: 'https://housetax.seosann.kr/',
        desc: '2026 보유세(재산세·종부세)·취득세·양도소득세·증여세·상속세를 상황별로 계산. 1주택 특례·2026 세제개편안 반영',
        categories: ['세금', '생활정보'],
        keywords: ['부동산세금계산기', '재산세계산기', '종합부동산세계산기', '종부세계산기', '양도소득세계산기', '양도세계산기', '취득세계산기', '증여세계산기', '상속세계산기', '주택보유세', '1세대1주택양도세비과세', '장기보유특별공제', '다주택양도세중과', '공정시장가액비율', '2026세제개편안']
    },
    'weekly-holiday-pay': {
        name: '주휴수당 계산기',
    ...
    'parkgolf-finder': {
        name: '전국 파크골프장 찾기',
        url: 'https://parkgolf.oldee.kr/',
        desc: '전국 파크골프장 342곳을 시·도·시군구별로 조회. 위치·홀수·전화·운영기관을 공공데이터·지자체 공식정보로 안내',
        categories: ['생활정보', '레저'],
        keywords: ['파크골프장', '전국파크골프장', '파크골프장찾기', '지역별파크골프장', '우리동네파크골프장', '파크골프장위치', '파크골프장홀수', '파크골프장전화번호', '파크골프장무료', '파크골프이용료', '파크골프코스', '파크골프장지도']
    },
    'minsaeng-support': {
        name: '민생지원금 총정리 (지자체·대상별)',
        url: 'https://minsaeng.oreurak.kr/',
        desc: '2026 전국·지자체 민생지원금을 대상별(청년·출산·어르신·취약계층·다자녀)·지역별로 신청 상태와 함께 정리',
        categories: ['생활정보', '복지'],
        keywords: ['민생지원금', '민생지원금2026', '지자체지원금', '민생회복지원금', '고유가피해지원금', '청년지원금2026', '출산지원금2026', '어르신지원금', '취약계층지원금', '다자녀지원금', '지역별지원금', '소비쿠폰', '긴급생활지원금', '우리동네지원금']
    },
    'wolse-tax-refund': {
        name: '월세 세액공제 계산기',
