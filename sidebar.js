...
const allProjects = {
    ...
    'basic-pension': {
        name: '기초연금 계산기',
        url: 'https://basicpension.8949ok.kr/',
        desc: '만 65세 이상 기초연금 수급자격·소득인정액·예상 수령액 계산',
        categories: ['정부지원', '재무계산', '생활정보'],
        keywords: ['기초연금계산기', '기초연금수급자격', '기초연금소득인정액', '기초연금재산기준', '기초연금부부감액', '기초연금국민연금연계감액', '기초연금신청방법', '2026기초연금', '기초연금선정기준액', '기초연금모의계산']
    },
    ...
    'kospi-up-down': {
        name: '코스피업다운',
        url: 'https://minion.toss.im/JyLhWJnC',
        desc: '매일 30초 KOSPI 종가 ↑↓ 맞추고 캐릭터 키우는 토스 미니앱 (모바일에서만 진입)',
        categories: ['토스미니앱', '주식', '코스피', '캐릭터'],
        keywords: ['코스피', 'KOSPI', '코스피 업다운', '코스피 종가', '코스피 예측', '주식 맞추기', '캐릭터 진화', '매일 미션', '리더보드', '토스 미니앱', '코스피 D-Day', '종가 알림', '명절 미션', '연속 정답', '오답왕']
    },
    'hangul-is-hard': {
    ...
    'energy-voucher': {
        ...
        desc: '냉난방비 지원 자격·가구원수별 금액 확인',
        categories: ['정부지원', '복지', '생활정보'],
        keywords: ['에너지바우처', '에너지바우처신청', '에너지바우처자격', '에너지바우처금액', '에너지바우처잔액조회', '에너지바우처신청기간', '에너지바우처사용처', '여름에너지바우처', '냉방비지원', '에너지바우처대상']
    },
    'tax-refund-lookup': {
        name: '미환급금 조회',
        url: 'https://refund.ssp2021.kr/',
        desc: '국세·지방세·건강보험·국민연금 미환급금 통합조회',
        categories: ['정부지원', '재무계산', '생활정보'],
        keywords: ['미환급금조회', '국세환급금조회', '지방세환급금조회', '건강보험환급금조회', '정부24미환급금', '홈택스환급금조회', '위택스환급금', '미수령환급금', '환급금조회방법', '숨은돈찾기']
    },
    'gohyang-donation': {
        name: '고향사랑기부제 계산기',
        url: 'https://gohyang.ryunadb.kr/',
        desc: '세액공제 + 답례품 30% 혜택·실부담금 계산',
        categories: ['재무계산', '절세', '기부'],
        keywords: ['고향사랑기부제', '고향사랑기부제세액공제', '고향사랑기부제답례품', '고향사랑기부제한도', '고향사랑e음', '고향사랑기부제연말정산', '고향사랑기부제계산기', '고향사랑기부제10만원', '고향사랑기부제답례품추천', '고향사랑기부제혜택']
    },
    'pungsu-insurance': {
        name: '소상공인 풍수해보험 안내',
        url: 'https://pungsu.oreurak.kr/',
        desc: '소상공인 상가·공장 풍수해·지진재해보험 정부지원·가입방법',
        categories: ['정부지원', '생활정보'],
        keywords: ['소상공인풍수해보험', '풍수해보험가입방법', '풍수해보험보험료지원', '풍수해지진재해보험', '소상공인재해보험', '상가풍수해보험', '침수피해보험', '태풍피해보상', '풍수해보험대상', '국민재난안전포털']
    },
    'capital-gains-tax': {
        name: '부동산 양도소득세 계산기',
        url: 'https://yangdo.winevisionshop.kr/',
        desc: '2026 양도가액·취득가액별 양도세·1세대1주택 비과세 12억·장기보유특별공제 최대 80%',
        categories: ['세금', '생활정보'],
        keywords: ['양도소득세계산기', '부동산양도세', '양도세계산', '1세대1주택비과세', '장기보유특별공제', '양도세세율', '다주택양도세', '주택양도세', '양도차익', '양도세비과세12억', '아파트양도세', '양도세얼마']
    },
    'property-holding-tax': {
        name: '재산세·종합부동산세 계산기',
        url: 'https://housetax.seosann.kr/',
        desc: '2026 공시가격별 주택 보유세·재산세 세율·종부세 공제 12억·1주택 특례',
        categories: ['세금', '생활정보'],
        keywords: ['재산세계산기', '종합부동산세계산기', '종부세계산기', '주택보유세', '재산세세율', '종부세세율', '공정시장가액비율', '종부세공제', '종부세12억', '1주택재산세', '공시가격재산세', '보유세계산']
    },
    'weekly-holiday-pay': {
        name: '주휴수당 계산기',
        url: 'https://juhu.oldee.kr/',
        desc: '2026 시급·주 근무시간별 주휴수당·조건·월 환산. 주 15시간 이상 개근 시',
        categories: ['생활정보', '세금'],
        keywords: ['주휴수당', '주휴수당계산기', '주휴수당계산', '주휴수당조건', '주휴수당15시간', '알바주휴수당', '주휴수당지급기준', '최저임금주휴수당', '파트타임주휴수당', '주휴수당월급', '단시간근로자주휴수당', '주휴수당얼마']
    },
    'gift-inheritance-tax': {
        name: '증여세·상속세 계산기',
        url: 'https://gifttax.ledgolf.kr/',
        desc: '2026 증여액별 세율 10~50%·관계별 공제·세액. 배우자 6억·자녀 5천만·혼인출산 1억',
        categories: ['세금', '생활정보'],
        keywords: ['증여세계산기', '상속세계산기', '증여세세율', '증여세공제', '증여재산공제', '증여세면제한도', '자녀증여세', '배우자증여세', '혼인증여공제', '상속세세율', '상속세공제', '증여세얼마']
    },
    'telecom-refund': {
        name: '통신비 환급금',
        url: 'https://telrefund.oreurak.kr/',
        desc: '통신 미환급금 스마트초이스 무료조회·통신요금 감면 대상·신청 방법',
        categories: ['생활정보', '금융'],
        keywords: ['통신비환급금', '통신비환급금조회', '통신미환급금조회', '통신요금미환급금', '스마트초이스미환급금', '통신비환급금신청', '휴대폰미환급금조회', '통신사미환급금', '통신요금감면', '통신비환급금대상', '통신비환급금정부24', '통신비환급금알뜰폰']
    },
    'car-refund': {
        name: '자동차 환급금 조회',
        url: 'https://carrefund.oldee.kr/',
        desc: '자동차 채권(지역개발채권) 미환급금·자동차세 과오납·자동차보험 과납보험료 무료조회 방법',
        categories: ['생활정보', '금융'],
        keywords: ['자동차환급금', '자동차환급금조회', '자동차채권환급금', '자동차채권미환급금조회', '자동차지역개발채권환급금', '자동차환급금신청', '자동차환급금정부24', '자동차보험과납보험료환급', '자동차세환급금조회', '자동차세연납환급', '폐차자동차세환급', '자동차환급금농협']
    },
    'culture-nuri-card': {
        name: '문화누리카드 잔액조회·사용처',
        url: 'https://nuri.oldee.kr/',
        desc: '문화누리카드(통합문화이용권) 2026 지원금 15만원·대상·발급·잔액조회·온라인 사용처·자동재충전 총정리',
        categories: ['생활정보', '복지'],
        keywords: ['문화누리카드', '문화누리카드잔액조회', '문화누리카드사용처', '문화누리카드온라인사용처', '문화누리카드발급', '문화누리카드신청방법', '문화누리카드재충전', '문화누리카드자동재충전', '문화누리카드대상자', '문화누리카드지원금', '문화누리카드사용기간', '문화누리카드분실신고', '통합문화이용권']
    },
    'wolse-tax-refund': {
        name: '월세 세액공제 계산기',
        url: 'https://wolse.o2u.kr/',
        desc: '월세 세액공제(월세환급금) 계산기·자격·한도·놓친 공제 5년 경정청구로 돌려받기',
        categories: ['금융', '생활정보'],
        keywords: ['월세세액공제', '월세환급금', '월세세액공제계산기', '월세세액공제조건', '월세세액공제한도', '월세세액공제신청방법', '월세세액공제경정청구', '월세환급경정청구', '월세소득공제', '월세세액공제총급여', '무주택세대주월세', '월세현금영수증']
    },
    'naeil-learning-card': {
        name: '국민내일배움카드',
        url: 'https://naeil.ttjc.co.kr/',
        desc: '국민내일배움카드 신청방법·자격·지원 한도(최대 500만원)·자기부담금·훈련장려금·고용24 발급 절차',
        categories: ['생활정보', '금융'],
        keywords: ['내일배움카드', '국민내일배움카드', '내일배움카드신청방법', '내일배움카드자격', '내일배움카드발급', '내일배움카드지원금', '내일배움카드잔액조회', '내일배움카드사용처', '내일배움카드재직자', '내일배움카드자기부담금', '내일배움카드훈련장려금', '내일배움카드KDT']
    },
    'credit-score-info': {
        name: '신용점수 정보',
    ...
    'parental-leave-pay': {
        ...
        desc: '2026 통상임금별 육아휴직급여·상한 250만원·6+6 부모제·기간',
        categories: ['정부지원', '생활정보'],
        keywords: ['육아휴직급여', '육아휴직급여계산기', '통상임금육아휴직급여', '육아휴직250만원', '육아휴직상한액', '6+6부모육아휴직제', '육아휴직기간', '사후지급금폐지', '배우자출산휴가20일', '육아기근로시간단축', '아빠육아휴직', '육아휴직급여신청방법']
    },
    'noran-umbrella-calc': {
        name: '노란우산공제 계산기',
        url: 'https://noran.oreurak.kr/',
        desc: '2026 사업소득 구간별 소득공제 한도·절세액·연금저축 합산까지 계산',
        categories: ['금융', '생활정보'],
        keywords: ['노란우산공제계산기', '노란우산소득공제', '노란우산소득공제한도', '노란우산절세', '노란우산세금', '소상공인소득공제', '자영업자절세', '프리랜서절세', '노란우산연말정산', '노란우산공제한도2026', '연금저축세액공제', '종합소득세절세']
    },
    'income-recognition-calc': {
        name: '소득인정액 계산기',
        url: 'https://income.ssp2021.kr/',
        desc: '2026 소득+재산 소득인정액 계산·기초연금 대상 조회(단독247·부부395.2만)',
        categories: ['정부지원', '생활정보'],
        keywords: ['소득인정액', '소득인정액계산기', '소득인정액조회', '소득인정액조회방법', '소득인정액계산', '기초연금소득인정액', '기초연금대상조회', '소득평가액', '재산의소득환산액', '기초연금선정기준', '소득인정액기준', '기초연금소득기준']
    },
    'health-insurance-fee-calc': {
        name: '지역가입자 건강보험료 계산기',
        url: 'https://healthfee.seosann.kr/',
        desc: '2026 소득·재산 기준 지역가입자 건강보험료·장기요양·피부양자 예상',
        categories: ['금융', '생활정보'],
        keywords: ['건강보험료계산기', '지역가입자건강보험료', '지역가입자보험료', '건보료계산기', '피부양자탈락건강보험료', '국민연금건강보험료', '재산건강보험료', '건강보험료재산공제', '장기요양보험료', '2026건강보험료율', '지역가입자건보료', '건강보험료계산']
    },
    'unemployment-benefit-calc': {
        name: '실업급여 계산기',
        url: 'https://jobless.gibugi.kr/',
        desc: '2026 구직급여 소정급여일수·나이·고용보험 가입기간별 총 수령액',
        categories: ['정부지원', '생활정보'],
        keywords: ['실업급여계산기', '실업급여금액', '실업급여얼마', '구직급여', '실업급여소정급여일수', '실업급여상한액', '실업급여하한액', '실업급여수급기간', '실업급여지급일수', '고용보험실업급여', '실업급여나이', '실업급여총액']
    },
    'parental-allowance': {
        name: '부모급여·아동수당 계산기',
        url: 'https://bomo.ydpn.kr/',
        desc: '2026 부모급여 0세 100만원·1세 50만원·아동수당·양육수당·첫만남이용권',
        categories: ['정부지원', '생활정보'],
        keywords: ['부모급여', '부모급여2026', '부모급여100만원', '부모급여50만원', '아동수당', '아동수당9세', '양육수당', '가정양육수당', '첫만남이용권', '영아수당', '부모급여아동수당중복', '부모급여신청방법']
    },
    'eitc-grant': {
        name: '근로장려금 계산기',
    ...
    'healthpoint': {
        name: '건강생활실천지원금 대상 확인',
        url: 'https://healthpoint.8949ok.kr/',
        desc: '예방형·관리형 대상 가능성과 신청방법 안내',
        categories: ['정부지원', '건강', '생활정보'],
        keywords: ['건강생활실천지원금', '건강실천지원금', '건강포인트', '걷기지원금', 'The건강보험', '예방형', '관리형', '고혈압', '당뇨병', '건강검진']
    },
    'xmas-gift': {
        name: '크리스마스 선물 추천',
        url: 'https://gift.wedclub.kr/',
        desc: '20~60대 여자·남자 연령별 크리스마스 선물 80가지',
        categories: ['생활정보', '쇼핑', '시즌'],
        keywords: ['크리스마스선물추천', '크리스마스선물순위', '여자친구크리스마스선물', '남자친구크리스마스선물', '부모님크리스마스선물', '아내크리스마스선물', '남편크리스마스선물', '20대크리스마스선물', '30대크리스마스선물', '크리스마스선물가격대']
    },
    'youth-benefits': {
        name: '청년혜택 찾기',
        url: 'https://youth.o2u.kr/',
        desc: '나이·상황별 2026 청년 지원금 한눈에 찾기',
        categories: ['정부지원', '청년', '생활정보'],
        keywords: ['청년혜택', '청년지원금', '청년정책2026', '청년미래적금조건', '청년월세지원신청', '청년내일저축계좌조건', '청년도약계좌종료', '청년정부지원금', '만34세청년혜택', 'K패스청년환급']
    },
    'onnuri': {
        name: '온누리상품권 할인 계산기',
        url: 'https://onnuri.8949ok.kr/',
        desc: '구매 할인 7% + 소득공제 40% 연간 혜택 계산',
        categories: ['정부지원', '생활정보', '절약'],
        keywords: ['온누리상품권할인', '온누리상품권계산기', '온누리상품권구매방법', '온누리상품권사용처', '온누리상품권소득공제', '온누리상품권구매한도', '디지털온누리상품권', '온누리상품권명절할인', '전통시장소득공제', '온누리상품권잔액조회']
    },
    'gicho': {
        name: '기초생활수급 자격확인',
        url: 'https://gicho.8949ok.kr/',
        desc: '2026 기준 중위소득으로 생계·의료·주거·교육급여 수급 가능성 확인',
        categories: ['정부지원', '복지', '생활정보'],
        keywords: ['기초생활수급자자격', '기초생활수급자조건', '기초생활수급자소득기준', '생계급여수급자격', '의료급여수급자격', '주거급여신청자격', '교육급여신청', '소득인정액계산', '기준중위소득2026', '차상위계층조건']
    },
    'pharmacy-open': {
        name: '지금열린약국',
